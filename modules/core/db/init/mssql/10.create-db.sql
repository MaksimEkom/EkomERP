...
create table EKOMERP_CALCULATION (
    ...
    NAME varchar(255) not null,
    PRODUCT_ID uniqueidentifier not null,
    SELLING_PRICE_TOTAL decimal(19, 2),
    AMOUNT_TAX decimal(19, 2),
    SELLING_PRICE_UNTAXED decimal(19, 2),
    PROFIT decimal(19, 2),
    COST_PRICE decimal(19, 2),
    DATE_ datetime2,
    FSZN_RATE decimal(19, 2),
    BGS_RATE decimal(19, 2),
    PRODUCTION_EXPENSES_RATE decimal(19, 2),
    COMMERCIAL_EXPENSES_RATE decimal(19, 2),
    PROFIT_RATE decimal(19, 2),
    FSZN decimal(19, 4),
    BGS decimal(19, 4),
    PRODUCTION_EXPENSES decimal(19, 2),
...
-- end EKOMERP_DOOR_ORDER
-- begin EKOMERP_GAUGING
